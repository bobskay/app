...
public class LogUtil {
	...
	public static void debug(Object msg){
		...
		int first=text.indexOf(Constant.LINE);
		int second=text.indexOf(Constant.LINE,first+1);
		int third=text.indexOf(Constant.LINE,second+1);
		text=text.substring(0,first)+text.substring(second,third);
		log.error(Constant.LINE+text);
	}
